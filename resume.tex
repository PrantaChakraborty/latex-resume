...
\section{Skills}
  ...
  \resumeSubHeadingListStart
    \small{\item{
        ...
        \textbf{Technologies:}{ Django, Django REST Framework, React.js, JQuery, Ajax, HTML \& CSS (Basic), PostgreSQL, Git, AWS, Jenkins,  Docker.} \\ \vspace{3pt}
...
\section{Education}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeEducationHeading
      ...
      {B.Sc. in Computer Science \& Engineering}{Oct 2016 \textbf{--} Oct 2022} \newline   \textbf{CGPA: 3.78/4.00}
